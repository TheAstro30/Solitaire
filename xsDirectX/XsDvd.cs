...
namespace xsDirectX
{
    ...
    public interface IDvdGraphBuilder
    {
        ...
        [PreserveSig]
        int GetDvdInterface([In] ref Guid riid, [Out] [MarshalAs(UnmanagedType.IUnknown)] out object ppvIf);
    ...
    public interface IDvdControl2
    {
        ...
        int SetSubpictureState(
            [In] [MarshalAs(UnmanagedType.Bool)] bool bState, DvdCmdFlags dwFlags, [Out] OptIDvdCmd ppCmd);
        ...
        [PreserveSig]
        int ActivateAtPosition(XsPointStruct point);

        [PreserveSig]
        int SelectAtPosition(XsPointStruct point);

        [PreserveSig]
        int PlayChaptersAutoStop(
            int ulTitle, int ulChapter, int ulChaptersToPlay, DvdCmdFlags dwFlags, [Out] OptIDvdCmd ppCmd);
    ...
    public interface IDvdInfo2
    {
        ...
        [PreserveSig]
        int GetTitleAttributes(int ulTitle, [Out] out DvdMenuAttr pMenu, IntPtr pTitle); // incomplete
        ...
        int GetDVDTextLanguageInfo(
            int ulLangIndex, out int pulNumOfStrings, out int pLangCode, out DvdCharSet pbCharacterSet);
        ...
        [PreserveSig]
        int IsAudioStreamEnabled(int ulStreamNum, [Out] [MarshalAs(UnmanagedType.Bool)] out bool pbEnabled);
        ...
        [PreserveSig]
        int GetButtonAtPosition(XsPointStruct point, out int pulButtonIndex);

        [PreserveSig]
        int GetCmdFromEvent(int lParam1, [Out] out IDvdCmd pCmdObj);
        ...
        [PreserveSig]
        int GetButtonRect(int ulButton, out XsRectStruct pRect);

        [PreserveSig]
        int IsSubpictureStreamEnabled(int ulStreamNum, [Out] [MarshalAs(UnmanagedType.Bool)] out bool pbEnabled);
