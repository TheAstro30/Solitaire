...
namespace libolv.CellEditing
{
    ...
    public class CellEditKeyEngine
    {
        ...
        protected OlvListItem ItemBeingEdited => ListView.CellEditEventArgs.ListViewItem;

        protected int SubItemIndexBeingEdited => ListView.CellEditEventArgs.SubItemIndex;
        ...
        protected virtual void HandleRowChange(Keys keyData, CellEditCharacterBehaviour behaviour)
        {
            ...
            CellEditKeyAtEdgeBehaviourMap.TryGetValue(keyData, out var atEdgeBehaviour);
