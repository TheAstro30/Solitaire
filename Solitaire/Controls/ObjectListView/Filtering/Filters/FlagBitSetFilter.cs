...
namespace Solitaire.Controls.ObjectListView.Filtering.Filters
{
    public class FlagBitSetFilter : OneOfFilter
    {
        private List<ulong> _possibleValuesAsUlongs = new List<ulong>();
        ...
        {
            _possibleValuesAsUlongs = new List<ulong>();
