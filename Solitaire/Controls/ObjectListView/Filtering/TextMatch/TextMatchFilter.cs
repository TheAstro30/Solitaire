...
namespace Solitaire.Controls.ObjectListView.Filtering.TextMatch
{
    public class TextMatchFilter : AbstractModelFilter
    {
        ...
        public static TextMatchFilter Regex(Solitaire.Controls.ObjectListView.ObjectListView olv, params string[] texts)
        {
        ...
        public static TextMatchFilter Prefix(Solitaire.Controls.ObjectListView.ObjectListView olv, params string[] texts)
        {
            var filter = new TextMatchFilter(olv)
                             {
                                 PrefixStrings = texts
        ...
        public static TextMatchFilter Contains(Solitaire.Controls.ObjectListView.ObjectListView olv, params string[] texts)
        {
            var filter = new TextMatchFilter(olv)
                             {
        ...
        public TextMatchFilter(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
            ListView = olv;
        }

        public TextMatchFilter(Solitaire.Controls.ObjectListView.ObjectListView olv, string text)
        {
            ListView = olv;
            ContainsStrings = new[]
                                  {
        ...
        public TextMatchFilter(Solitaire.Controls.ObjectListView.ObjectListView olv, string text, StringComparison comparison)
        {
            ListView = olv;
            ContainsStrings = new[]
                                  {
        ...
        public bool HasComponents => _matchingStrategies.Count > 0;
