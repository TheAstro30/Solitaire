...
namespace Solitaire.Controls.ObjectListView.Filtering
{
    public class FilterMenuBuilder
    {
        ...
        public static Bitmap ClearFilteringImage = Resources.clear_filter;
        ...
        public virtual ToolStripDropDown MakeFilterMenu(ToolStripDropDown strip, Solitaire.Controls.ObjectListView.ObjectListView listView, OlvColumn column)
        {
        ...
        protected virtual List<ICluster> Cluster(IClusteringStrategy strategy, Solitaire.Controls.ObjectListView.ObjectListView listView, OlvColumn column)
        {
...
// ReSharper restore AssignNullToNotNullAttribute
        ...
        protected virtual void HandleItemChecked(object sender, ItemCheckEventArgs e)
        {
            ...
            if (!(column?.ListView is Solitaire.Controls.ObjectListView.ObjectListView))
            {
                return;
            }
        ...
        {
            var olv = column.ListView as Solitaire.Controls.ObjectListView.ObjectListView;
