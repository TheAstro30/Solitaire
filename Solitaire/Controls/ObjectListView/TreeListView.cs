...
using Solitaire.Controls.ObjectListView.Implementation.TreeView;
...
namespace Solitaire.Controls.ObjectListView
{
    public partial class TreeListView : VirtualObjectListView
    {
        ...
        {
            get => _treeRenderer ?? (_treeRenderer = new TreeRenderer());
            set
            {
        ...
        public override void RefreshObjects(IList modelObjects)
        {
            ...
            var firstChange = (from object model in modelObjects
                               ...
                               into index where index >= 0 select index).Concat(new[] {int.MaxValue}).Min();
