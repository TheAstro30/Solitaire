...
namespace Solitaire.Controls.ObjectListView.Rendering.Adornments
{
    public class TextAdornment : GraphicAdornment
    {
        ...
        [Browsable(false)]
        public Brush BackgroundBrush => new SolidBrush(Color.FromArgb(_workingTransparency, BackColor));

        [Category("ObjectListView"), Description("The color of the border around the text"), DefaultValue(typeof(Color), "")]
        public Color BorderColor { get; set; } = Color.Empty;

        [Browsable(false)]
        public Pen BorderPen => new Pen(Color.FromArgb(_workingTransparency, BorderColor), BorderWidth);
        ...
        [Browsable(false)]
        public Brush TextBrush => new SolidBrush(Color.FromArgb(_workingTransparency, TextColor));
