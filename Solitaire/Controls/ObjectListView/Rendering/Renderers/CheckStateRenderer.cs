    ...
    public class CheckStateRenderer : BaseRenderer
    {
        public override void Render(Graphics g, Rectangle r)
        {
            ...
            if (IsPrinting)
            {
                ...
                var key = Solitaire.Controls.ObjectListView.ObjectListView.CheckedKey;
                if (state == CheckState.Unchecked)
                {
                    key = Solitaire.Controls.ObjectListView.ObjectListView.UncheckedKey;
                }
                if (state == CheckState.Indeterminate)
                {
                    key = Solitaire.Controls.ObjectListView.ObjectListView.IndeterminateKey;
                }
