    ...
    public class BaseRenderer : AbstractRenderer
    {
        ...
        protected virtual Rectangle? EffectiveCellPadding
        {
            get
            {
                ...
                if (OlvSubItem?.CellPadding != null)
                {
                    return OlvSubItem.CellPadding.Value;
                }
                if (ListItem?.CellPadding != null)
                {
                    return ListItem.CellPadding.Value;
                }
                if (Column?.CellPadding != null)
                {
                    return Column.CellPadding.Value;
                }
                return ListView?.CellPadding;
            }
        }
        ...
        protected virtual StringAlignment EffectiveCellVerticalAlignment
        {
            get
            {
                ...
                if (OlvSubItem?.CellVerticalAlignment != null)
                {
                    return OlvSubItem.CellVerticalAlignment.Value;
                }
                if (ListItem?.CellVerticalAlignment != null)
                {
                    return ListItem.CellVerticalAlignment.Value;
                }
                if (Column?.CellVerticalAlignment != null)
                {
                    return Column.CellVerticalAlignment.Value;
                }
                return ListView?.CellVerticalAlignment ?? StringAlignment.Center;
            }
        }
        ...
        public bool UseGdiTextRendering
        {
            get =>
                ...
                !IsPrinting && _useGdiTextRendering;
        ...
        {
            get => _aspect ?? (_aspect = _column.GetValue(RowObject));
            set => _aspect = value;
        }
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public Solitaire.Controls.ObjectListView.ObjectListView ListView { get; set; }
        ...
        {
            get => _textBrush ?? new SolidBrush(GetForegroundColor());
        ...
        {
            var alignment = Column?.TextAlign ?? HorizontalAlignment.Left;
            switch (alignment)
            {
        ...
        protected virtual int CalculateImageWidth(Graphics g, object imageSelector)
        {
            ...
            if (il != null)
            {
                ...
                {
                    case int selector:
                        selectorAsInt = selector;
                        break;

                    case string selectorAsString:
        ...
        public override bool RenderItem(DrawListViewItemEventArgs e, Graphics g, Rectangle itemBounds, object rowObject)
        {
            ...
            SubItem = null;
            ListView = (Solitaire.Controls.ObjectListView.ObjectListView)ListItem.ListView;
        ...
        {
            ClearState();
            ListView = (Solitaire.Controls.ObjectListView.ObjectListView)item.ListView;
            ListItem = item;
        ...
        protected void StandardRender(Graphics g, Rectangle r)
        {
            ...
            if (Solitaire.Controls.ObjectListView.ObjectListView.ShowCellPaddingBounds)
            {
        ...
        protected virtual bool IsCheckBoxDisabled =>
            ...
            (ListView.CellEditActivation == Solitaire.Controls.ObjectListView.ObjectListView.CellEditActivateMode.None ||
        ...
        protected bool IsItemHot =>
            ...
            ListView.HotColumnIndex == (Column?.Index ?? 0) &&
        ...
        protected virtual StringFormat StringFormatForGdiPlus
        {
            get
            {
                var fmt = new StringFormat
                {
                    ...
                    Alignment = Column?.TextStringAlign ?? StringAlignment.Near
                };
                if (!CanWrap)
                {
