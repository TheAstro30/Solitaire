...
namespace Solitaire.Controls.ObjectListView.Rendering.Renderers
{
    public class ImageRenderer : BaseRenderer
    {
        ...
        protected Timer Tickler => _tickler ?? (_tickler = new Timer(OnTimer, null, Timeout.Infinite, Timeout.Infinite));
        ...
        protected Image GetImageFromAspect()
        {
            ...
            if (OlvSubItem != null && OlvSubItem.ImageSelector is Image selector)
            {
