...
namespace Solitaire.Controls.ObjectListView.Utilities
{
    public interface IGenerator
    {
        void GenerateAndReplaceColumns(Solitaire.Controls.ObjectListView.ObjectListView olv, Type type, bool allProperties);
    ...
    public class Generator : IGenerator
    {
        ...
        {
            get => _instance ?? (_instance = new Generator());
            set => _instance = value;
        }

        public static void GenerateColumns(Solitaire.Controls.ObjectListView.ObjectListView olv, IEnumerable enumerable)
        {
            GenerateColumns(olv, enumerable, false);
        }
        
        public static void GenerateColumns(Solitaire.Controls.ObjectListView.ObjectListView olv, IEnumerable enumerable, bool allProperties)
        {
        ...
        public static void GenerateColumns(Solitaire.Controls.ObjectListView.ObjectListView olv, Type type)
        {
            Instance.GenerateAndReplaceColumns(olv, type, false);
        }
        
        public static void GenerateColumns(Solitaire.Controls.ObjectListView.ObjectListView olv, Type type, bool allProperties)
        {
        ...
        /* Public interface */
        public virtual void GenerateAndReplaceColumns(Solitaire.Controls.ObjectListView.ObjectListView olv, Type type, bool allProperties)
        {
        ...
        /* Implementation */
        protected virtual void ReplaceColumns(Solitaire.Controls.ObjectListView.ObjectListView olv, IList<OlvColumn> columns)
        {
            olv.Reset();
        ...
        public virtual void PostCreateColumns(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
            ...
            tlv.CanExpandGetter = delegate(object x)
                                      {
                                          try
                                          {
                                              ...
                                              return !Solitaire.Controls.ObjectListView.ObjectListView.IsEnumerableEmpty(result);
                                          }
