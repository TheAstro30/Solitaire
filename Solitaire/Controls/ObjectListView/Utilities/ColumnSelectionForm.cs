...
namespace Solitaire.Controls.ObjectListView.Utilities
{
    public partial class ColumnSelectionForm : Form
    {
        ...
        public void OpenOn(Solitaire.Controls.ObjectListView.ObjectListView listView)
        {
            OpenOn(listView, listView.View);
        }

        public void OpenOn(Solitaire.Controls.ObjectListView.ObjectListView listView, View view)
        {
        ...
        protected void InitializeForm(Solitaire.Controls.ObjectListView.ObjectListView listView, View view)
        {
        ...
        protected void Apply(Solitaire.Controls.ObjectListView.ObjectListView listView, View view)
        {
            listView.Freeze();
