...
namespace Solitaire.Controls.ObjectListView.Utilities
{
    public class OlvExporter
    {
        ...
        public OlvExporter(Solitaire.Controls.ObjectListView.ObjectListView olv) : this(olv, olv.Objects)
        {
            /* Empty */
        }

        public OlvExporter(Solitaire.Controls.ObjectListView.ObjectListView olv, IEnumerable objectsToExport)
        {
            ...
            ModelObjects = Solitaire.Controls.ObjectListView.ObjectListView.EnumerableToArray(objectsToExport, true);
        }
