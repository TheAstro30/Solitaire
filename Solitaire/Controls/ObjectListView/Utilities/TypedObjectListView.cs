...
namespace Solitaire.Controls.ObjectListView.Utilities
{
    public class TypedObjectListView<T> where T : class
    {
        ...
        private Solitaire.Controls.ObjectListView.ObjectListView _olv;
        private TypedCheckStateGetterDelegate _checkStateGetter;
        private TypedCheckStatePutterDelegate _checkStatePutter;

        public TypedObjectListView(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
            _olv = olv;
        }

        public virtual T CheckedObject => (T)_olv.CheckedObject;
        ...
        public virtual Solitaire.Controls.ObjectListView.ObjectListView ListView
        {
            get => _olv;
            set => _olv = value;
        }
