...
namespace Solitaire.Controls.ObjectListView.SubControls
{
    internal sealed class GlassPanelForm : Form
    {
        internal IOverlay Overlay;

        private Solitaire.Controls.ObjectListView.ObjectListView _objectListView;
        ...
        /* Commands */     
        public void Bind(Solitaire.Controls.ObjectListView.ObjectListView olv, IOverlay overlay)
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var g = e.Graphics;
            g.TextRenderingHint = Solitaire.Controls.ObjectListView.ObjectListView.TextRenderingHint;
            g.SmoothingMode = Solitaire.Controls.ObjectListView.ObjectListView.SmoothingMode;
        ...
        internal void UpdateTransparency()
        {
            ...
            Opacity = transparentOverlay?.Transparency/255.0f ?? _objectListView.OverlayTransparency/255.0f;
        }
