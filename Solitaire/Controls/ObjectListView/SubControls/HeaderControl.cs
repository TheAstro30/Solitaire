...
namespace Solitaire.Controls.ObjectListView.SubControls
{
    public class HeaderControl : NativeWindow
    {
        ...
        public HeaderControl(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
            ListView = olv;
        ...
        protected Solitaire.Controls.ObjectListView.ObjectListView ListView { get; set; }
        ...
        protected Rectangle DrawFilterIndicator(Graphics g, Rectangle r)
        {
            ...
            Image indicator = Resources.column_filter_indicator;
            var x = r.Right - width;
        ...
        {
            return Resources.column_filter_indicator == null || r.Width < 48
                       ? 0
                       : Resources.column_filter_indicator.Width + 1;
        }
