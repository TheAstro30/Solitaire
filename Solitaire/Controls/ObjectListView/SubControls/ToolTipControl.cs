...
namespace Solitaire.Controls.ObjectListView.SubControls
{
    public class ToolTipControl : NativeWindow
    {
        ...
        {
            get => NativeMethods.GetWindowLong(Handle, GwlStyle);
            set => NativeMethods.SetWindowLong(Handle, GwlStyle, value);
        }

        public bool IsBalloon
        {
            get => (WindowStyle & TtsBalloon) == TtsBalloon;
            set
            {
                if (IsBalloon == value)
                {
                ...
                if (value)
                {
                    ...
                    if (!Solitaire.Controls.ObjectListView.ObjectListView.IsVistaOrLater)
                    {
        ...
        public Color BackColor
        {
            ...
            set
            {
                ...
                if (Solitaire.Controls.ObjectListView.ObjectListView.IsVistaOrLater) { return; }
        ...
        {
            get => GetDelayTime(TtdtAutopop);
            set => SetDelayTime(TtdtAutopop, value);
        }

        public int InitialDelay
        {
            get => GetDelayTime(TtdtInitial);
            set => SetDelayTime(TtdtInitial, value);
        }

        public int ReshowDelay
        {
            get => GetDelayTime(TtdtReshow);
