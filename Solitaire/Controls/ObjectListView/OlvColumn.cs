    ...
    public class OlvColumn : ColumnHeader
    {
        ...
        public string GroupWithItemCountFormatOrDefault
        {
            get
            {
                ...
                if (ListView != null)
                {
                    _cachedGroupWithItemCountFormat = ((Solitaire.Controls.ObjectListView.ObjectListView)ListView).GroupWithItemCountFormatOrDefault;
        ...
        public string GroupWithItemCountSingularFormatOrDefault
        {
            get
            {
                ...
                if (ListView != null)
                {
                    _cachedGroupWithItemCountSingularFormat = ((Solitaire.Controls.ObjectListView.ObjectListView)ListView).GroupWithItemCountSingularFormatOrDefault;
        ...
        {
            get => HeaderFormatStyle?.Normal.ForeColor ?? Color.Empty;
            set
            {
        ...
        {
            get => _headerTextAlign ?? TextAlign;
        ...
        public RenderDelegate RendererDelegate
        {
            get
            {
                ...
                return renderer?.RenderDelegate;
            }
        ...
        {
            return GroupKeyToTitleConverter != null
                       ? GroupKeyToTitleConverter(value)
        ...
        public CheckState GetCheckState(object rowObject)
        {
            ...
            return GetValue(rowObject) is bool aspectAsBool
                       ? (aspectAsBool ? CheckState.Checked : CheckState.Unchecked)
        ...
        public string GetCheckStateImage(object rowObject)
        {
            ...
            {
                case CheckState.Checked:
                    return Solitaire.Controls.ObjectListView.ObjectListView.CheckedKey;

                case CheckState.Unchecked:
                    return Solitaire.Controls.ObjectListView.ObjectListView.UncheckedKey;
            }
            return Solitaire.Controls.ObjectListView.ObjectListView.IndeterminateKey;
        }
        ...
        public Type DataType
        {
            get
            {
                if (_dataType == null)
                {
                    var olv = ListView as Solitaire.Controls.ObjectListView.ObjectListView;
