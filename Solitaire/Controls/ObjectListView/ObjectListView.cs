...
using Solitaire.Controls.ObjectListView.Implementation.Events;
...
namespace Solitaire.Controls.ObjectListView
{
    ...
    public partial class ObjectListView : ListView, ISupportInitialize
    {
        ...
        {
            private readonly Solitaire.Controls.ObjectListView.ObjectListView _objectListView;

            public SuspendSelectionDisposable(Solitaire.Controls.ObjectListView.ObjectListView objectListView)
            {
        ...
        public static SmoothingMode SmoothingMode { get; set; } = SmoothingMode.HighQuality;
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        protected bool SelectionEventsSuspended => _suspendSelectionEventCount > 0;
        ...
        protected virtual int GetActualImageIndex(object imageSelector)
        {
            ...
            if (imageSelector is int selector)
            {
                return selector;
            }
        ...
        private void SetupBaseImageList()
        {
            ...
            {
                var width = _shadowedImageList?.ImageSize.Width ?? 16;
        ...
        protected virtual void UpdateHotItem(OlvListViewHitTestInfo hti)
        {
            ...
            try
            {
                ...
                if (UseHotItem && HotItemStyle?.Overlay != null)
                {
                    RefreshOverlays();
                }
            }
