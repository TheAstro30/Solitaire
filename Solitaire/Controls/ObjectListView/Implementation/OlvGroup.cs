...
namespace Solitaire.Controls.ObjectListView.Implementation
{
    ...
    public class OlvGroup
    {
        ...
        {
            get => GetOneState(GroupState.LvgsCollapsed);
            set => SetOneState(value, GroupState.LvgsCollapsed);
        }

        public bool Collapsible
        {
            get => GetOneState(GroupState.LvgsCollapsible);
        ...
        public Solitaire.Controls.ObjectListView.ObjectListView ListView { get; protected set; }
        public string Name { get; set; }

        public bool Focused
        {
            get => GetOneState(GroupState.LvgsFocused);
            set => SetOneState(value, GroupState.LvgsFocused);
        }

        public bool Selected
        {
            get => GetOneState(GroupState.LvgsSelected);
        ...
        {
            get => GetOneState(GroupState.LvgsSubseted);
        ...
        {
            if (imageSelector == null || ListView?.GroupImageList == null)
            {
                return -1;
            }
            switch (imageSelector)
            {
                ...
                case string imageSelectorAsString:
        ...
        /* Commands */
        public void InsertGroupNewStyle(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
            ListView = olv;
            NativeMethods.InsertGroup(olv, AsNativeGroup(true));
        }

        public void InsertGroupOldStyle(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
            ListView = olv;
