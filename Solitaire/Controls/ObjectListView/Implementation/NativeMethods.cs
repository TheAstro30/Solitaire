...
namespace Solitaire.Controls.ObjectListView.Implementation
{
    internal static class NativeMethods
    {
        ...
        public static Point GetColumnSides(Solitaire.Controls.ObjectListView.ObjectListView lv, int columnIndex)
        {
        ...
        {
            SendMessage(objectListView.Handle, LvmSetselectedcolumn, value?.Index ?? -1, 0);
        }
        ...
        public static int GetGroupInfo(Solitaire.Controls.ObjectListView.ObjectListView olv, int groupId, ref Lvgroup2 group)
        {
            return (int)SendMessage(olv.Handle, LvmGetgroupinfo, groupId, ref group);
        }

        public static GroupState GetGroupState(Solitaire.Controls.ObjectListView.ObjectListView olv, int groupId, GroupState mask)
        {
            return (GroupState)SendMessage(olv.Handle, LvmGetgroupstate, groupId, (int)mask);
        }

        public static int InsertGroup(Solitaire.Controls.ObjectListView.ObjectListView olv, Lvgroup2 group)
        {
            return (int)SendMessage(olv.Handle, LvmInsertgroup, -1, ref group);
        }

        public static int SetGroupInfo(Solitaire.Controls.ObjectListView.ObjectListView olv, int groupId, Lvgroup2 group)
        {
            return (int)SendMessage(olv.Handle, LvmSetgroupinfo, groupId, ref group);
        }

        public static int SetGroupMetrics(Solitaire.Controls.ObjectListView.ObjectListView olv, Lvgroupmetrics metrics)
        {
        ...
        public static int SetGroupImageList(Solitaire.Controls.ObjectListView.ObjectListView olv, ImageList il)
        {
        ...
        public static int HitTest(Solitaire.Controls.ObjectListView.ObjectListView olv, ref Lvhittestinfo hittest)
        {
