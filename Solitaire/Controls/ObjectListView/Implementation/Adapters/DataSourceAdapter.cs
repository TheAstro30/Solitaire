...
namespace Solitaire.Controls.ObjectListView.Implementation.Adapters
{
    public class DataSourceAdapter : IDisposable
    {
        ...
        public DataSourceAdapter(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
        ...
        protected virtual void BindListView(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
            if (olv == null)
            {
                return;
        ...
        protected virtual void UnbindListView(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
            if (olv == null)
            {
                return;
        ...
        /* Initialization */
        private void Init(Solitaire.Controls.ObjectListView.ObjectListView olv)
        {
        ...
        protected virtual void RebindDataSource(bool forceDataInitialization)
        {
            ...
            if (ListView?.BindingContext != null && DataSource != null)
            {
