...
namespace Solitaire.Controls.ObjectListView.Implementation.Events
{
    public class HotItemChangedEventArgs : EventArgs
    {
        ...
        {
            return $"NewHotCellHitLocation: {HotCellHitLocation}, HotCellHitLocationEx: {HotCellHitLocationEx}, NewHotColumnIndex: {HotColumnIndex}, NewHotRowIndex: {HotRowIndex}, HotGroup: {HotGroup}";
        }
    }
}
