...
namespace Solitaire.Controls.ObjectListView.Implementation.TreeView
{
    [Flags]
    ...
    public class Branch
    {
        ...
        public virtual bool CanExpand => Tree.CanExpandGetter != null && Model != null && Tree.CanExpandGetter(Model);
        ...
        {
            get => ((_flags & BranchFlags.FirstBranch) != 0);
            set
            {
                if (value)
                {
        ...
        {
            get => ((_flags & BranchFlags.LastChild) != 0);
            set
            {
                if (value)
                {
        ...
        {
            get => ((_flags & BranchFlags.OnlyBranch) != 0);
            set
            {
                if (value)
                {
        ...
        public int Level => ParentBranch?.Level + 1 ?? 0;
        ...
        public virtual bool Visible => ParentBranch == null || ParentBranch.IsExpanded && ParentBranch.Visible;
