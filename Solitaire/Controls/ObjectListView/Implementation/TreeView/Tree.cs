    ...
    public class Tree : IVirtualListDataSource, IFilterableDataSource
    {
        ...
        public IEnumerable RootObjects
        {
            ...
            set
            {
                ...
                foreach (var br in _trunk.ChildBranches)
                {
                    br.RefreshChildren();
                }
                RebuildList();
        ...
        public virtual Branch GetBranch(object model)
        {
            ...
            _mapObjectToBranch.TryGetValue(model, out var br);
            return br;
        }
        ...
        {
            return model != null && _mapObjectToIndex.TryGetValue(model, out var index) ? index : -1;
        }
