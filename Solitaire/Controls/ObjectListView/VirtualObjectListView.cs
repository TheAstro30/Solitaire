...
using Solitaire.Controls.ObjectListView.Implementation.VirtualGroups;

namespace Solitaire.Controls.ObjectListView
{
    public class VirtualObjectListView : Solitaire.Controls.ObjectListView.ObjectListView
    {
        ...
        public override bool CanShowGroups =>
            ...
            (IsVistaOrLater && GroupingStrategy != null);
        ...
        {
            get => ((VirtualListVersion1DataSource)_virtualListDataSource).RowGetter;
